...
**Status:** Skeleton only. The bundle registers, but the compensation domain services, exporters and UI are not implemented yet — every stub throws. See `.specs/kimai-pro-rata-time-export_SPEC.md` for the complete technical specification.
